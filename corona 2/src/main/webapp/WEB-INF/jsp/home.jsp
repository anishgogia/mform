...
<nav id="navbar">
        ...
        <ul>
            ...
            <li class="item"><a href="">Need Resources</a></li>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input class="un " type="text" name="mobile" placeholder="Phone Number">
    ...
    <div class="blood2">
        ...
        <br><br>
       <%--  <form>
            <input class="money" type="text" name="amount" placeholder="Amount">
