...
<body>
    <nav id="navbar">
        ...
        <ul>
            <li class="item"><a href="corona.html"></a>Home</li>
            <li class="item"><a href="facebook.com"></a>Donor</li>
            <li class="item"><a href=""></a>Need Help</li>
            <li class="item"><a href=""></a>Donation</li>
            <li class="item"><a href=""></a>Admin</li>
        </ul>
    </nav>
    <br>
    <br><br>
    ...
    <div class="svgf">
        <div class="para">
                ...
                or using an alcohol based rub frequently and not touching your face. 
                    ...
                    <div>
                    <button class="btn"><span>Help! </span></button>
                </div>
        </div>
        <!-- <div class="insvg"> -->
