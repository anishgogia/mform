...
<nav id="sidenav">
        ...
        <ul>
            ...
            <li class="table2"><a href="done/resources">Requests </a></li>
            <li class="table2"><a href="done/approvedresources">Approved Requests</a></li>
            ...
            <tbody>
                <tr>
                    ...
                    <td width="60">${resources.pno}</td>
          			...
          			<td width="60"><a href="approve${resources.address}"><img id=delete src="resources/img/update.png" alt=""></a></td>
