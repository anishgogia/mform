            ...
            <tbody>
                <tr>
                    ...
                    <%-- <td width="60"><a href="update/${bloodd.phn}"><img id=update src="resources/img/update.png" alt=""></a>--%>
                     ...
                     <td width="60">    <button class="btn" data-target="#mymodal" data-toggle="modal"><img id=update src="resources/img/update.png" alt=""></button>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input class="un " type="text" name="mobile" value=${bloodd.phn}>
